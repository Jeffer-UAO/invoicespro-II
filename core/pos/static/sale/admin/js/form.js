  ...
  calculateInvoice: function () {
    ...
    this.detail.products.forEach(function (value, index, array) {
      ...
      value.price_with_vat =
        value.price_current + value.price_current * value.iva;
        ...
        },
        {
          ...
          render: function (data, type, row) {
            return (
              ...
              "$" +
              row.price_current +
              '" onchange="sale.updatePrice(this, \'' +
              row.code +
              "')\">" +
              '<select id="selectPrecio" onchange="sale.openModal(this, \'' +
              row.code +
              "')\">" +
              '<option value="pvp">OPC</option>' +
              '<option value="pvp">Men</option>' +
              '<option value="pvp1">May</option>' +
              '<option value="pvp2">Esp</option>' +
              '<option value="pvp3">Exc</option>' +
              "</select>" +
              "</div>"
            );
          },
