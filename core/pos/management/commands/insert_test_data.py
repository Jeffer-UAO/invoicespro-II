...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('schema_name', type=str, help='Nombre del esquema')
    ...
    def handle(self, *args, **options):
        ...
        with schema_context(company.scheme.schema_name):
            ...
            for item in VOUCHER_TYPE:
                ...
                Receipt.objects.get_or_create(code=item[0], defaults={'name': item[1], 'start_number': '000000000', 'end_number': '999999999', 'current_number': current_number})
