...
class UserForm(forms.ModelForm):
    ...
    class Meta:
        ...
        exclude = ['is_change_password', 'is_staff', 'user_permissions',
                   'date_joined', 'last_login', 'is_superuser', 'email_reset_token']
...
class ProfileForm(forms.ModelForm):
    ...
    class Meta:
        ...
        exclude = ['is_change_password', 'is_active', 'is_staff', 'user_permissions',
                   'password', 'date_joined', 'last_login', 'is_superuser', 'groups', 'email_reset_token']
